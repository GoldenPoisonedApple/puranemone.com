	...
	return (
		<>
			...
			<div className={`app ${showContent ? 'show' : ''}`}>
				...
				<p>せっかくなので、今年の抱負や去年の出来事を書き初めにしてみてはいかがでしょう。</p>
				<p className="app-notice">SNSへの本サイトの共有はお控えください。ご友人方との共有に留めていただけるとPCの生存率が上がります。<br/>※ブラウザを変更したりクッキーを削除すると違うユーザ判定となります。</p>
