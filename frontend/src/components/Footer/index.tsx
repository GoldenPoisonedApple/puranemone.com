				...
				<section className="footer-section">
					...
					<div className="footer-section-content">
						<p className="footer-text">
							皆様におかれましては去年はどのような年だったでしょうか？私の去年の抱負は「英語を話す」でしたが、代わりにTokiPonaという言葉を読み書きしていました。なんと120前後しか単語が無いんです。面白い！<br/>今年は午年、丙午(ひのえ・うま)で、どちらも火の性質を持ち、情熱・活力などを象徴するとのこと。せっかくなので何か新しい事に挑戦してみてはいかがでしょうか。<br/>(今年一番の衝撃はVRChatでした。様々な海外の人と気軽に話せるのは単純に楽しい！かつ無料！かつカワイイ！)
						</p>
						<p className="footer-text">
